...
function createData(id, name, price, supplie_name, supplie_id,  weight) {
  return {
    id,
    name,
    price,
...
export default function TableProducts() {
  ...
  return (
    <Box sx={{ width: '100%' }} p={{ xs: 3, sm: 3, md: 3 }} my={{ xs: 2, sm: 3, md: 4 }} >
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.supplie_name}</TableCell>
                    <TableCell align="right">{row.weight}</TableCell>
                    <TableCell align="right">
                     
                      <IconButton onClick={() => handleDetails(row.supplie_id)}>
                        <VisibilityIcon />
                      </IconButton>
                    </TableCell>
                  </TableRow>
